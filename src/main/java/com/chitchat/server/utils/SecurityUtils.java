package com.chitchat.server.utils;
...
public class SecurityUtils {
    ...
    @Value("${chitchat.jwt.access-token-validity-in-minutes}")
    private Long accessTokenExpiration;

    @Value("${chitchat.jwt.refresh-token-validity-in-days}")
    ...
    public String createAccessToken(String emailUsernamePhone, LoginResponse dto) {
        ...
        Instant validity = now.plus(accessTokenExpiration, ChronoUnit.MINUTES);
     ...
     public String createRefreshToken(String emailUsernamPhone, LoginResponse dto) {
        Instant now = Instant.now();
        Instant validity = now.plus(this.refreshTokenExpiration, ChronoUnit.DAYS);
